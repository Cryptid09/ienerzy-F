...
const EmiOverview = () => {
  ...
  if (isLoading) return <div className="bg-white border rounded-xl shadow-sm p-5">Loading EMI data...</div>;
  if (error) return <div className="bg-white border rounded-xl shadow-sm p-5">Error loading EMI data</div>;
